...
class ClobClient:
    ...
    async def post_order(self, order, orderType: OrderType = OrderType.GTC):
        ...
        return await self.client.post("{}{}".format(self.host, POST_ORDER), headers=headers, data=body)
    ...
    async def cancel(self, order_id):
        ...
        headers = create_level_2_headers(self.signer, self.creds, request_args)
        return await self.client.delete("{}{}".format(self.host, CANCEL), headers=headers, data=body)
    ...
    async def get_price_history_with_interval(self, token_id: str, interval: str, fidelity: str):
        """
